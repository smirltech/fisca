                                                ...
                                                <table class="w-full text-sm ltr:text-left rtl:text-right text-gray-700 ">
                                                    ...
                                                    @foreach($employees as $employee)
                                                        <tr class="bg-white border-b text-13 border-gray-300 dark:bg-transparent dark:text-zink-200 dark:border-zink-50">
                                                            ...
                                                            <td class="p-3">{{ $employee->first_name . " " . $employee->last_name. " ". $employee->middle_name }}
                                                                <span class="block text-gray-500 text-13">{{ $employee->email }}</span>
                                                            </td>
                                                            <td class="p-3">{{ $employee->department }}</td>
                                                            <td class="p-3">{{'$' . Number::format($employee->base_salary)}}</td>
                                                            <td class="p-3">
                                                                @if($employee->payed)
                                                            ...
                                                            <td class="p-3">
                                                                <div><i class="fab fa-cc-visa  mr-1"></i> {{ $employee->phone_number }}</div>
                                                            </td>
                                                            <td class="p-3">
