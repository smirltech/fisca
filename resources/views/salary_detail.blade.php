    ...
    <div class="flex flex-col flex-1">
        ...
        <main class="h-full pb-16 overflow-y-auto">
            <div class="container grid px-6 mx-auto">
                ...
                >--}}
                <div
                    class="my-6 flex items-center p-4 mb-8 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple">
                    <svg
                        class="w-5 h-5 mr-2"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                ...
                                <path fill-rule="evenodd"
                                      d="M10 2a8 8 0 100 16 8 8 0 000-16zm1 9a1 1 0 11-2 0V7a1 1 0 112 0v4zm-1-12a10 10 0 110 20 10 10 0 010-20z"
                                      clip-rule="evenodd"/>
                            </svg>
                        </div>
                        <div>
